    ...
    <div className="space-y-4">
      ...
      <div className="block">
        <div className="mb-1 flex items-center justify-between gap-3">
          ...
          <Select
            value={draft.referenceImageEditAction ?? 'ask'}
            ...
            className="w-32 rounded-xl border border-gray-200/60 bg-white/50 px-3 py-1.5 text-xs text-gray-700 dark:border-white/[0.08] dark:bg-white/[0.03] dark:text-gray-200"
          />
        </div>
      ...
      <div className="block">
        ...
        <div data-selectable-text className="text-xs text-gray-500 dark:text-gray-500">
          开启后，图像生成完成时，会发送浏览器系统通知。浏览器可能会请求通知权限或默认拒绝，请查看相关提示。
        </div>
      </div>
    </div>
  )
